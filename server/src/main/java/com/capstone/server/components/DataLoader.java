...
//    LandRepository landRepository;
    ...
    public void run(ApplicationArguments args) {
        ...
        Card swamp = new Card("Swamp", "colorless", 0, "{T}, add 1 black mana", 0, 0, "LAND", "1","https://c1.scryfall.com/file/scryfall-cards/border_crop/front/a/b/ab950987-d88c-4326-98f4-1b1195788921.jpg?1624535761", "0.00");
        deck1.addCard(swamp);
        deck1.addCard(swamp);
        deck1.addCard(swamp);
        deck1.addCard(swamp);
        ...
        Card darkRitual = new Card("Dark Ritual", "Black", 1, "Add 3 Black Mana to your Mana Pool", 0, 0, "INSTANT", "2","", "0.00");
        deck1.addCard(darkRitual);
        deck1.addCard(darkRitual);
        deck1.addCard(darkRitual);
        deck1.addCard(darkRitual);
        cardRepository.save(darkRitual);
        Card unholyStrength = new Card("Unholy Strength", "Black", 1, "Enchanted creature get +2/+1",0,0,"ENCHANTMENT", "3","", "0.00");
        deck1.addCard(unholyStrength);
        deck1.addCard(unholyStrength);
        deck1.addCard(unholyStrength);
        deck1.addCard(unholyStrength);
        cardRepository.save(unholyStrength);
        Card blackKnight = new Card("Black Knight", "Black", 2, "First Strike, Protection from White",2,2,"CREATURE", "4","", "0.00");
        deck1.addCard(blackKnight);
        deck1.addCard(blackKnight);
        deck1.addCard(blackKnight);
        deck1.addCard(blackKnight);
        cardRepository.save(blackKnight);
        Card ritualOfSoot = new Card("Ritual of Soot", "Black", 4,"Destroy each creature with converted mana cost 3 or less", 0, 0, "SORCERY", "5","","0.0");
        ...
        Card ayara = new Card("Ayara, First of Lochtwain", "Black", 3,"Whenever Ayara, First of Locthwain or another black creature enters the battlefield under your control, each opponent loses 1 life and you gain 1 life." +
                "{T}, Sacrifice another black creature: Draw a card.", 2,3, "CREATURE", "6","https://c1.scryfall.com/file/scryfall-cards/border_crop/front/e/d/ed0ace28-9a33-4f0d-b8c8-f5517f20ccf1.jpg?1572490057", "16.49" );
        deck1.addCard(ayara);
        deck1.addCard(ayara);
        deck1.addCard(ayara);
        deck1.addCard(ayara);
        ...
        Card lurrus = new Card("Lurrus of the Dream-Den", "Black/White", 3, "Companion — Each permanent card in your starting deck has mana value 2 or less. (If this card is your chosen companion, you may put it into your hand from outside the game for {3} any time you could cast a sorcery.)\n" +
                "Lifelink" + "During each of your turns, you may cast one permanent spell with mana value 2 or less from your graveyard.", 3, 2, "CREATURE", "7","", "0.00");
        ...
        Card cauldronFamiliar = new Card("Cauldron familiar", "Black", 1, "When Cauldron Familiar enters the battlefield, each opponent loses 1 life and you gain 1 life." +
                "Sacrifice a Food: Return Cauldron Familiar from your graveyard to the battlefield.",1,1, "CREATURE", "8","", "0.00");
        ...
        Card bloodthirstyAerialist = new Card("Bloodthirsty Aerialist", "Black", 3, "Flying" +
                "Whenever you gain life, put a +1/+1 counter on Bloodthirsty Aerialist.", 2,3, "CREATURE", "9","", "0.00");
        ...
        Card terror = new Card("Terror", "Black", 2, "Destroy target nonartifact, nonblack creature. It can't be regenerated.", 0, 0,"INSTANT", "10","", "0.00");
        deck1.addCard(terror);
        deck1.addCard(terror);
        deck1.addCard(terror);
        deck1.addCard(terror);
        cardRepository.save(terror);
        Card witchsOven = new Card("Witch's Oven", "colorless", 1, "{T}, Sacrifice a creature: Create a Food token. If the sacrificed creature's toughness was 4 or greater, create two Food tokens instead. (They're artifacts with {2}, {T}, Sacrifice this artifact: You gain 3 life.)", 0, 0, "ARTEFACT", "11","", "0.00");
